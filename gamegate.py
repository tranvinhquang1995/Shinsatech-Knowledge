...
def generate_gamegate_answer(api_key: str, context: str, user_question: str) -> str:
    ...
    6. Đối với Module / Category là Template thì hãy xuất nguyên văn băn ở ô Detailed Process đúng định dạng bao gồm cả in đậm in nghiêng và vị trí xuống hàng, tuyệt đối không được tự ý thay đổi cấu trúc hay định dạng.
    """
